...
from .modules.backbones.resnet_ibn import resnet34_ibn_a, resnet18_ibn_a, resnet34_ibn_b, resnet18_ibn_b, resnet101_ibn_a,resnet101_ibn_b, resnet50_ibn_a
...
class Res_Unet(nn.Module):
    def __init__(self, in_channels, n_classes, backbone, model_path, dropout_rate=0.0, scse=False, use_mish=False, db_block=False, hypercolumn=False, use_cc=False, deepsupversion=False, decode_dim=256):
        ...
        self.conv_last = nn.Sequential(
            nn.Conv2d(self.decode_dim // 2, n_classes, 1),
            nn.Sigmoid(),
            )
