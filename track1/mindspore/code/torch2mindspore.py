...
from src.config import config_hrnetv2_w18 as model_config
# from src.config import hrnetw18_config as model_config


def parse_args():
    """Get parameters from command line."""
    parser = argparse.ArgumentParser(description="Transform torch model to mindspore format.")
    parser.add_argument("--pth_path", type=str, default="pre_model/hrnetv2_w18_imagenet_pretrained.pth", help="Torch model path.")
    parser.add_argument("--ckpt_path", type=str, default="pre_model/hrnetv2_w18_imagenet_pretrained.ckpt", help="Output checkpoint storage path.")
...
if __name__ == "__main__":
    ...
    net = get_seg_model(model_config)
